...
function page_header($page_title = '', $display_online_list = true, $item_id = 0, $item = 'forum')
{
 ...
 //INI projtrad
	...
	if (!function_exists('fnc_idioma'))
	{
		include($phpbb_root_path . 'includes/functions_traducao.' . $phpEx);
	}
  
$lingua = fnc_idioma();   //projtrad

$link_u_register = append_sid("{$phpbb_root_path}ucp.$phpEx", 'mode=register');

if ($lingua != 'pt_br')
{
$link_u_register = 'XX_register_en.php';
}
//FIM projtrad
	...
	$template->assign_vars(array(
		...
		'U_REGISTER'			=> $link_u_register, //append_sid("{$phpbb_root_path}ucp.$phpEx", 'mode=register'),    //projtrad
